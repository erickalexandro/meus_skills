...
description: "Cria, reescreve ou melhora advertoriais de resposta direta (páginas-matéria entre o anúncio e a oferta: personal story, exposé clínico, listicle, amplificador, híbrido) do zero até o HTML final pronto pra subir — pesquisa profunda de produto/público/mercado/avatar, estratégia (consciência, framework, categoria, ângulo, nome do vilão/mecanismo), copy bloco a bloco, design simples e legível pro público, imagens e build em arquitetura ecotoken. Use SEMPRE que o Erick pedir para escrever, refazer, adaptar para outro avatar/ângulo ou reescrever um advertorial / 'ADV' / página de pré-venda / native ad page, mesmo que ele não diga a palavra 'skill'. Não é a skill para o anúncio em si (use copywriting-para-criativos) nem para gerar só bullets (use gerador-de-bullets, que esta skill pode chamar no meio), nem para checklist, nota, rodada de análise, QA ou entrega (use revisar-advertorial)."
---
